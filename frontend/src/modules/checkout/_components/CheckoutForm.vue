    ...
    <form @submit.prevent="onSubmit" class="space-y-4">
      ...
      <div>
        ...
        <div class="relative">
          ...
          <input
            ...
            placeholder="demo"
            class="w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-primary
            focus:border-primary transition-colors bg-[#0a0a0a] text-white placeholder-gray-500"
      ...
      <div>
        ...
        <div class="relative">
          ...
          <textarea
            ...
            rows="2"
            class="w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-primary
            focus:border-primary transition-colors resize-none bg-[#0a0a0a] text-white placeholder-gray-500"
      ...
      <div>
        ...
        <input
          ...
          focus:ring-primary focus:border-primary transition-colors bg-[#0a0a0a]
      ...
      <div>
        <label class="block text-sm font-medium text-gray-300 mb-1"> Order Notes </label>
        <textarea
          ...
          bg-[#0a0a0a] text-white placeholder-gray-500"
        />
      </div>
    </form>
  </div>
